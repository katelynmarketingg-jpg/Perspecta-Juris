...
Total atual: **276 asserções** em 9 suítes. Cada suíte sai com código 0 se passar.
...
| `etapa7.calculos` | 122 | correção monetária, rescisão, dosimetria, locação, prazos, INSS |
